...
var arr = [101, 135, 96, 71, 63, 142, 157, 139, 39, 119, 247, 209, 235],
    itmd = [],
    visited = []
...
function drawBars(start, end) {
    ...
    for (let i = 0; i < len_of_arr; i++) {
        ...
        ctrl.fillStyle = "#feb236"




        // Size of rectangle of bars
        ctrl.fillRect(30 * i, 300 - arr[i], 20, arr[i])
    ...
    for (let i = start; i <= end; i++) {
        ctrl.fillStyle = "#d64161"
        ctrl.fillRect(30 * i, 300 - arr[i], 20, arr[i])
        ctrl.fillStyle = "lightseagreen"
        ctrl.fillRect(30 * i, 300, 20, arr[i])
        visited[i] = 1
    }
}
